package
{
   ...
   public class _cc_FlexInit
   {
      ...
      public static function init(param1:IFlexModuleFactory) : void
      {
         ...
         styleNames = ["highlightColor","fontAntiAliasType","errorColor","kerning","backgroundDisabledColor","iconColor","modalTransparencyColor","textRollOverColor","shadowCapColor","textIndent","themeColor","modalTransparency","textDecoration","headerColors","fontThickness","textAlign","fontFamily","textSelectedColor","selectionDisabledColor","fontGridFitType","letterSpacing","rollOverColor","fontStyle","dropShadowColor","fontSize","shadowColor","selectionColor","disabledColor","dropdownBorderColor","fontWeight","disabledIconColor","modalTransparencyBlur","leading","color","alternatingItemColors","fontSharpness","barColor","modalTransparencyDuration","footerColors"];
         i = 0;
