package anifire.util.Crypto
{
   public class TEA
   {
      ...
      public static function encrypt(param1:String, param2:String) : String
      {
         ...
         {
            var _loc14_:*;
            _loc3_[_loc14_ = _loc5_++] = 0;
         }
         var _loc7_:Number = Number(_loc3_[_loc5_ - 1]);
         var _loc8_:Number = Number(_loc3_[0]);
         var _loc9_:Number = 2654435769;
         var _loc12_:Number = Math.floor(6 + 52 / _loc5_);
         var _loc13_:Number = 0;
         while(_loc12_-- > 0)
         {
            _loc11_ = (_loc13_ += _loc9_) >>> 2 & 3;
            _loc6_ = 0;
            while(_loc6_ < _loc5_ - 1)
            {
               _loc8_ = Number(_loc3_[_loc6_ + 1]);
      ...
      public static function decrypt(param1:String, param2:String) : String
      {
         ...
         var _loc9_:Number = 2654435769;
         var _loc12_:Number;
         var _loc13_:Number = (_loc12_ = Math.floor(6 + 52 / _loc5_)) * _loc9_;
         while(_loc13_ != 0)
         {
            _loc11_ = _loc13_ >>> 2 & 3;
            _loc6_ = _loc5_ - 1;
            while(_loc6_ > 0)
            {
               _loc10_ = ((_loc7_ = Number(_loc3_[_loc6_ - 1])) >>> 5 ^ _loc8_ << 2) + (_loc8_ >>> 3 ^ _loc7_ << 4) ^ (_loc13_ ^ _loc8_) + (_loc4_[_loc6_ & 3 ^ _loc11_] ^ _loc7_);
               _loc8_ = _loc3_[_loc6_] = _loc3_[_loc6_] - _loc10_;
               _loc6_--;
            }
            _loc10_ = ((_loc7_ = Number(_loc3_[_loc5_ - 1])) >>> 5 ^ _loc8_ << 2) + (_loc8_ >>> 3 ^ _loc7_ << 4) ^ (_loc13_ ^ _loc8_) + (_loc4_[_loc6_ & 3 ^ _loc11_] ^ _loc7_);
