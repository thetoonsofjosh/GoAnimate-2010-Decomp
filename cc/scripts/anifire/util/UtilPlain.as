package anifire.util
{
   ...
   public class UtilPlain
   {
      ...
      private static function transverseFamilyListener(param1:EventListenerWithData) : void
      {
         ...
         var targetIndex:int = int(listenerObj.data["targetIndex"]);
      ...
      private static function getMultipleInstanceRecursive(param1:DisplayObject, param2:RegExp, param3:Array) : void
      {
         var _loc4_:DisplayObjectContainer = null;
      ...
      public static function getMultipleInstance(param1:DisplayObject, param2:RegExp) : Array
      {
      ...
      public static function transverseFamily(param1:DisplayObject, param2:Function) : void
      {
         var _loc3_:int = 0;
         var _loc4_:DisplayObject = null;
         ...
         if(param1 is DisplayObjectContainer)
         {
            ...
            {
               _loc4_ = _loc5_.getChildAt(_loc3_);
               UtilPlain.transverseFamily(_loc4_,param2);
               _loc3_++;
            }
         }
      }
      ...
      public static function switchParent(param1:DisplayObjectContainer, param2:DisplayObjectContainer) : void
      {
         ...
         trace("switchparent:" + param1.numChildren);
...
class EventListenerWithData
{
   ...
   public function EventListenerWithData(param1:Function, param2:Object = null)
   {
      super();
