package anifire.util
{
   ...
   public class UtilNetwork
   {
      ...
      {
         var _loc2_:String = String(URLUtil.getProtocol((Application.application as Application).url));
         if(_loc2_ == "file")
         {
      ...
      public static function getGetThemeRequest(param1:String, param2:Boolean) : URLRequest
      {
         ...
         else
         {
            ...
            _loc6_[ServerConstants.PARAM_THEME_ID] = param1;
            _loc4_ = getRequest(_loc5_,URLRequestMethod.POST,_loc6_,null);
         }
         return _loc4_;
      }
      ...
      public static function getGetCcComponentStateFileRequest(param1:String, param2:String, param3:String, param4:String) : URLRequest
      {
         ...
         var _loc8_:String = getHostUrl() + "store/cc_store/" + escape(param1) + "/" + escape(param2) + "/" + escape(param3) + "/" + escape(param4) + "?v=" + _loc7_;
      ...
      public static function getGetThemeAssetRequest(param1:String, param2:String, param3:String, param4:String = "", param5:int = -1) : URLRequest
      {
         ...
         param5 = param5 < 0 ? ServerConstants.STORE_VERSION : param5;
         _loc7_ = "store/" + param1 + "/";
         ...
         {
            _loc7_ += "char/" + param2 + "/" + param4;
         }
         else if(param3 == ServerConstants.PARAM_CHAR_FACIAL)
         {
            if((_loc9_ = param2.split(".")).length > 0)
            {
               param2 = String(_loc9_[0]);
            }
            _loc7_ += "char/" + param2 + "/head/" + param4;
         }
         else if(param3 == ServerConstants.PARAM_PROP_EX)
         {
            _loc7_ += "prop/" + param2 + ".zip";
         }
         else if(param3 == ServerConstants.PARAM_PROP_STATE)
         {
            _loc7_ += "prop/" + param2 + "/" + param4;
         }
         ...
         {
            _loc7_ += "effect/" + param2;
         }
         else if(param3 == ServerConstants.PARAM_BUBBLE)
         {
            _loc7_ += "bubble/" + param2;
         }
         var _loc8_:String = getHostUrl() + _loc7_ + "?v=" + param5;
         if(param1 == "ugc" && param3 == ServerConstants.PARAM_CHAR)
         {
            _loc10_ = new URLVariables();
            _loc11_ = Util.getFlashVar();
            UtilPlain.addFlashVarsToURLvar(_loc11_,_loc10_);
            (_loc6_ = new URLRequest(ServerConstants.ACTION_GET_CHAR)).method = URLRequestMethod.POST;
            _loc10_[ServerConstants.PARAM_ASSET_ID] = param2;
            _loc6_.data = _loc10_;
         }
         else
         {
            _loc6_ = getRequest(_loc8_,URLRequestMethod.GET,null,null);
         }
         return _loc6_;
      }
      ...
      public static function getClientLocaleUrl(param1:String, param2:String, param3:String) : String
      {
         ...
         var _loc4_:String = String(URLUtil.getProtocol((Application.application as Application).url));
         ...
         {
            _loc7_ = ServerConstants.CLIENT_LOCALE_PATH;
         }
         return _loc7_ + "/" + param1 + "/" + param2 + "/" + param3 + "Resources_" + param2 + ".swf" + "?v=" + _loc6_;
      }
