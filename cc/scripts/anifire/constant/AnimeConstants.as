package anifire.constant
{
   public class AnimeConstants
   {
      ...
      public static const FRAME_PER_PIXEL:Number = 0.48;
      ...
      public static const MOVIE_VERSION:Number = 3;
      ...
      public static const PIXEL_PER_WORD:Number = 65;
      ...
      public static const PIXEL_PER_SEC:Number = FRAME_PER_SEC / FRAME_PER_PIXEL;
      
      public static const SOUND_LENGTH_MINIMUM:Number = 0.2 * PIXEL_PER_SEC;
      
      public static const SCENE_LENGTH_DEFAULT:Number = 2.5 * PIXEL_PER_SEC;
      ...
      public static const MIN_TIME_TO_BUFFER:Number = 10000;
      ...
      public static const SCENE_LENGTH_MINIMUM:Number = 0.2 * PIXEL_PER_SEC;
