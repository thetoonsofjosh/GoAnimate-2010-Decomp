package anifire.cc_theme_lib
{
   ...
   public class CcColor
   {
      ...
      public var ccColorThumb:anifire.cc_theme_lib.CcColorThumb;
      
      public var ccComponent:anifire.cc_theme_lib.CcComponent;
      ...
      public function deserialize(param1:XML, param2:CcTheme, param3:CcCharacter) : void
      {
         this.colorValue = uint(Number(param1.toString()));
         this.ccColorThumb = param2.getColorThumbByInternalId(anifire.cc_theme_lib.CcColorThumb.generateInternalId(param1.@r));
