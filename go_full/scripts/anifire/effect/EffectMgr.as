package anifire.effect
{
   public class EffectMgr
   {
      ...
      private static var _effect:anifire.effect.SuperEffect = new anifire.effect.SuperEffect();
      ...
      public static function getEffectByXML(param1:XML) : anifire.effect.SuperEffect
      {
         ...
         var _loc8_:anifire.effect.SuperEffect;
      ...
      private static function createEffect(param1:String = "ZOOM", param2:String = "") : anifire.effect.SuperEffect
      {
         switch(param1)
         {
            case TYPE_ZOOM:
