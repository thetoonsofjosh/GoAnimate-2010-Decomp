package anifire.util
{
   ...
   public class FontManager
   {
      ...
      private static var _fontManager:anifire.util.FontManager;
       
      
      private var _fonts:anifire.util.UtilHashArray;
      ...
      public static function getFontManager() : anifire.util.FontManager
      {
         if(_fontManager == null)
         {
            _fontManager = new anifire.util.FontManager();
            _fontManager.init();
         }
         return _fontManager;
      }
      ...
      public function getFonts() : anifire.util.UtilHashArray
      {
         return this._fonts;
      }
      ...
      {
         this._fonts = new anifire.util.UtilHashArray();
      }
