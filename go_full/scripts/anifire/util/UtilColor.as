package anifire.util
{
   ...
   public class UtilColor
   {
      ...
      public static function setGreen(param1:Sprite, param2:uint) : void
      {
         ...
         var _loc4_:uint = uint(_loc3_.redOffset << 16 | param2 << 8 | _loc3_.blueOffset);
      ...
      {
         var _loc3_:ColorTransform = param1.transform.colorTransform;
         var _loc4_:uint = uint(_loc3_.redOffset << 16 | _loc3_.greenOffset << 8 | param2);
         setRGB(param1,_loc4_);
      }
      ...
      {
         var _loc5_:uint = uint(param2 << 16 | param3 << 8 | param4);
         setRGB(param1,_loc5_);
      }
      
      public static function setAssetPartColor(param1:DisplayObject, param2:String, param3:uint = 4294967295) : uint
      {
         var _loc5_:int = 0;
         var _loc6_:Sprite = null;
         var _loc7_:ColorTransform = null;
         var _loc4_:Array = new Array();
         if((_loc4_ = UtilPlain.getColorItem(param1,param2)).length > 0)
         {
            _loc5_ = 0;
      ...
      public static function setRGB(param1:Sprite, param2:uint = 4294967295) : void
      {
      ...
      {
         var _loc3_:ColorTransform = param1.transform.colorTransform;
         var _loc4_:uint = uint(param2 << 16 | _loc3_.greenOffset << 8 | _loc3_.blueOffset);
         setRGB(param1,_loc4_);
      }
