package anifire.util
{
   ...
   public class UtilAVM1server implements IEventDispatcher
   {
      ...
      private function pollCommand(param1:Event) : void
      {
         ...
         {
            trace("inside avm2. command polled: " + this._avm1movie[INTERFACE_COMMAND_FROM_AVM1] + " | param is: " + this._avm1movie[INTERFACE_PARAM_FROM_AVM1]);
         ...
         if(this._commandPool.length > 0 && this._avm1movie[INTERFACE_COMMAND_FROM_AVM2] == COMMAND_NULL)
         {
            ...
            trace("AVM1Server command sent. command: " + _loc3_.command + " | param: " + _loc3_.param);
...
class CommandEntry
{
   ...
   public function CommandEntry(param1:int, param2:Number)
   {
      super();
