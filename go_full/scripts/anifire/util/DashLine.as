package anifire.util
{
   ...
   public class DashLine
   {
      ...
      public function curveTo(param1:Number, param2:Number, param3:Number, param4:Number) : void
      {
         ...
         var _loc5_:Bezje2D;
         var _loc6_:Number = (_loc5_ = new Bezje2D(new Point(this.px,this.py),new Point(param3,param4),new Point(param1,param2))).length;
         if(this.draw_start >= _loc6_)
         {
            this.draw_start -= _loc6_;
         }
         ...
         else
         {
            if(this.draw_start < 0)
            {
               ...
               this.draw_start += this.blocksize;
            }
            if(this.draw_start < _loc6_)
            {
               ...
               while(_loc9_ < _loc10_)
               {
                  ...
                  _loc9_ += this.blocksize;
               }
               if((_loc11_ = _loc6_ - _loc9_) > this.dashsize)
               {
         ...
         else
         {
            ...
            if(this.draw_start < _loc4_)
            {
               ...
               while(_loc10_ < _loc11_)
               {
                  ...
                  _loc10_ += this.blocksize;
               }
               _loc8_ = this.px + _loc10_ * _loc3_.x;
               _loc9_ = this.py + _loc10_ * _loc3_.y;
               if((_loc12_ = _loc4_ - _loc10_) > this.dashsize)
               {
