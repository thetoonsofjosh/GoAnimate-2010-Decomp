package anifire.util
{
   ...
   public class UtilLazyHelper extends EventDispatcher
   {
      ...
      private function onScrolled(param1:ScrollEvent) : void
      {
         ...
         {
            _loc2_ = Number(this.container.verticalScrollPosition);
            _loc3_ = Number(this.container.maxVerticalScrollPosition);
         }
         else
         {
            _loc2_ = Number(this.container.horizontalScrollPosition);
            _loc3_ = Number(this.container.maxHorizontalScrollPosition);
         }
