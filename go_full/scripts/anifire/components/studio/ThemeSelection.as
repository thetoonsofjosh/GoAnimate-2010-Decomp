package anifire.components.studio
{
   ...
   public class ThemeSelection extends Canvas implements IBindingClient
   {
      ...
      private function highlightThemeItem(param1:String) : void
      {
         ...
         var _loc2_:Number = Number(this._menu.numChildren);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      override public function initialize() : void
      {
         ...
         bindings = this._ThemeSelection_bindingsSetup();
         watchers = [];
         target = this;
      ...
      public function buildMenu(param1:UtilHashArray, param2:int = 0, param3:Boolean = true, param4:Boolean = true) : void
      {
         ...
         while(_loc7_ < param1.length)
         {
            ...
            if(param1.getKey(_loc7_) == "Comm" && (param3 || param4) || Console.getConsole().isThemeCcRelated(param1.getKey(_loc7_)))
            {
      ...
      private function onMouseOverTheme(param1:Event) : void
      {
         ...
         var _loc5_:Number = Number(this._assetTypeBox.numChildren);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            ...
            else if(!UtilUser.isBeta() && (_loc9_ != null && _loc9_ == String(_loc4_["id"])))
            {
               Canvas(this._assetTypeBox.getChildAt(_loc6_)).height = 0;
            }
            else
