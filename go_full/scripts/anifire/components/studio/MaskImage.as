package anifire.components.studio
{
   ...
   public class MaskImage extends TitleWindow implements IBindingClient
   {
      ...
      private static var _main:anifire.components.studio.MaskImage;
      ...
      public static function getConsole() : anifire.components.studio.MaskImage
      {
         if(_main != null)
         {
            return _main;
      ...
      {
         anifire.components.studio.MaskImage._watcherSetupUtil = param1;
      }
      ...
      private function chgShape(param1:Event = null, param2:String = null) : void
      {
         ...
         if(param1 != null)
         {
            _loc3_ = String(param1.currentTarget.data);
         }
         else if(param2 != null)
         {
            _loc3_ = param2;
      ...
      private function flip(param1:String) : void
      {
         switch(param1)
         {
            case "x":
               ...
               this.myImage.x = this.myImage.scaleX == 1 ? -this._imageWidth / 2 : this._imageWidth / 2;
            ...
            case "y":
               ...
               this.myImage.y = this.myImage.scaleY == 1 ? -this._imageHeight / 2 : this._imageHeight / 2;
               this.myImageCan.rotation = -this.myImageCan.rotation;
               this._canRotate.rotation = this.myImageCan.rotation;
               this.synShadowImage();
         }
      ...
      private function add() : void
      {
         ...
         else
         {
            ...
            _loc3_.scaleX = _loc3_.scaleY = _loc5_ > _loc6_ ? _loc5_ : _loc6_;
            ...
            {
               _loc9_.scaleX = _loc9_.scaleY = _loc5_ > _loc6_ ? _loc5_ : _loc6_;
            }
      ...
      {
         var _loc2_:String = String(param1.currentTarget.selectedValue);
      ...
      private function drawBackground() : void
      {
         ...
         while(_loc4_ < this.myBackgroundCan.height)
         {
            ...
            {
               _loc8_ = 0;
               _loc8_ = _loc3_ % 2 == 0 && _loc2_ % 2 == 0 || _loc2_ % 2 != 0 && _loc3_ % 2 == 1 ? 14540253 : 16777215;
      ...
      override public function initialize() : void
      {
         ...
         var watchers:Array;
         var i:uint;
         var target:anifire.components.studio.MaskImage = null;
         var watcherSetupUtilClass:Object = null;
         mx_internal::setDocumentDescriptor(this._documentDescriptor_);
         bindings = this._MaskImage_bindingsSetup();
         watchers = [];
         target = this;
      ...
      {
         var _loc2_:Number = Number((param1.currentTarget.data as Array)[0]);
         var _loc3_:Number = Number((param1.currentTarget.data as Array)[1]);
