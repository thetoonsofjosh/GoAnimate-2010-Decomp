package anifire.components.containers
{
   ...
   public class AssetInfoWindow_inlineComponent1 extends HBox implements IBindingClient
   {
      ...
      private var _88844982outerDocument:anifire.components.containers.AssetInfoWindow;
      ...
      public function set outerDocument(param1:anifire.components.containers.AssetInfoWindow) : void
      {
      ...
      public function get outerDocument() : anifire.components.containers.AssetInfoWindow
      {
      ...
      override public function initialize() : void
      {
         ...
         bindings = this._AssetInfoWindow_inlineComponent1_bindingsSetup();
         watchers = [];
         target = this;
