package anifire.components.containers
{
   ...
   public class AssetInfoWindow extends TitleWindow implements IBindingClient
   {
      ...
      private function assetIsCharacter() : void
      {
         ...
         else
         {
            ...
            if(this._thumb != null && this._thumb is CharThumb)
            {
               ...
               for each(_loc1_ in (this._thumb as CharThumb).actions)
               {
      ...
      public function setAsDefault(param1:String) : void
      {
         ...
         var _loc3_:String = String(this._actionList[0]["name"]);
         var _loc4_:String = String(this._actionList[0]["id"]);
      ...
      override public function initialize() : void
      {
         ...
         bindings = this._AssetInfoWindow_bindingsSetup();
         watchers = [];
         target = this;
      ...
      private function updateAsset(param1:Event) : void
      {
         ...
         var _loc3_:BadwordFilter = null;
         if(this.mode == this.INFO_MODE)
         {
            _loc2_ = !!this._radioPublic.selected ? true : false;
            _loc3_ = new BadwordFilter(Console.getConsole().getBadTerms(),null,Console.getConsole().getWhiteTerms());
            if(_loc3_.containsBadword(this._txtTitle.text))
            {
      ...
      private function updateZoomDurGx(param1:FlexEvent = null) : void
      {
         ...
         if(this._mode == this.LEN_MODE)
         {
            _loc2_ = Number(this._sliderStEd.getThumbAt(this._firstThumbId).y);
