package anifire.control
{
   ...
   public class Control extends Sprite
   {
      ...
      private var _lineColor:Number = 16711680;
      
      protected var _assetWidth:Number = 0;
      
      private const MIN_WIDTH:Number = 20;
      ...
      private const MIN_HEIGHT:Number = 20;
      ...
      private function clearDraw() : void
      {
         ...
         this._leftTopController_sp = null;
         this._middleTopController_sp = null;
         this._rightTopController_sp = null;
         this._leftMiddleController_sp = null;
         this._rightMiddleController_sp = null;
         this._leftBottomController_sp = null;
         this._middleBottomController_sp = null;
         this._rightBottomController_sp = null;
         this._rotateController_sp = null;
      ...
      {
         param3 = param3 <= 0 ? this._assetWidth : param3;
         param4 = param4 <= 0 ? this._assetHeight : param4;
      ...
      protected function drawControlPoint(param1:Number = 0, param2:Number = 0, param3:Number = 0, param4:Number = 0) : void
      {
         ...
         if(this.dragable)
         {
            ...
            if(this._rotateController_sp == null)
            {
               ...
               _loc8_ = new ColorTransform(0,1,0);
      ...
      private function onControlDownHandler(param1:MouseEvent) : void
      {
         ...
         _loc4_ = this._assetWidth >= this.MIN_WIDTH ? this.MIN_WIDTH : this._assetWidth + this._offset;
         _loc5_ = this._assetHeight >= this.MIN_HEIGHT ? this.MIN_HEIGHT : this._assetHeight + this._offset;
         var _loc6_:String = String(param1.target.name);
         switch(_loc6_)
         {
            case LEFT_TOP:
...
class ControlStuff
{
   ...
   public function ControlStuff(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number = 1, param6:Number = 1, param7:Number = 0, param8:Number = 0)
   {
      super();
      this._x = param1;
      this._y = param2;
