package anifire.playback
{
   ...
   public class Behaviour implements IPlayable, IEventDispatcher
   {
      ...
      private var _firstBehavior:anifire.playback.Behaviour = null;
      
      private var _tempImageData:ByteArray;
      ...
      private var _myChar:anifire.playback.Character;
      
      private var _nextBehavior:anifire.playback.Behaviour;
      ...
      private var _prevBehavior:anifire.playback.Behaviour;
      
      private var _charObj:DisplayObjectContainer;
      
      private var _customHead:anifire.playback.Prop = null;
      ...
      public function setWear(param1:DisplayObject, param2:anifire.playback.Prop) : void
      {
      ...
      public function get firstBehavior() : anifire.playback.Behaviour
      {
      ...
      public function get myChar() : anifire.playback.Character
      {
         return this._myChar;
      }
      ...
      public function initRemoteData(param1:PlayerDataStock, param2:Boolean = false) : void
      {
         ...
         else
         {
            ...
            ccMaker.initBySwfs(iDataStock.getPlayerData(this.getFile())["xml"],iDataStock.getPlayerData(this.getFile())["imageData"]);
         }
      }
      ...
      public function set prevBehavior(param1:anifire.playback.Behaviour) : void
      {
      ...
      protected function pretendToBe(param1:anifire.playback.Behaviour) : void
      {
      ...
      public function setHead(param1:DisplayObject = null) : void
      {
         var _loc2_:DisplayObjectContainer = null;
         ...
         this.setHeadForCharObj(param1,_loc2_);
      }
      
      public function get nextBehavior() : anifire.playback.Behaviour
      {
         return this._nextBehavior;
      }
      
      public function set myChar(param1:anifire.playback.Character) : void
      {
         this._myChar = param1;
      }
      ...
      {
         trace("onInitCCRemoteDataCompleted");
         if(param1 != null)
         {
      ...
      public function set firstBehavior(param1:anifire.playback.Behaviour) : void
      {
      ...
      public function setWearForCharObj(param1:DisplayObject, param2:anifire.playback.Prop, param3:DisplayObjectContainer) : void
      {
         ...
         if((_loc4_ = UtilPlain.getHead(param3)) != null)
         {
            ...
            {
               _loc6_ = param2 != null ? param2.getBundle().getBounds(param2.getBundle()).y : 0;
            }
            if(_loc5_ != null)
            {
               _loc5_.y = _loc6_;
         ...
         {
            trace("Warning! Prop container not found due to propContainer-not-found for " + this.getFile());
         }
      }
      ...
      public function get prevBehavior() : anifire.playback.Behaviour
      {
      ...
      private function setHeadForCharObj(param1:DisplayObject, param2:DisplayObjectContainer) : void
      {
         var _loc3_:DisplayObjectContainer = null;
         _loc3_ = UtilPlain.getHead(param2);
         if(_loc3_ != null)
         {
            if(param1 != null)
            {
               _loc3_.getChildByName(AnimeConstants.MOVIECLIP_DEFAULT_HEAD).alpha = 0;
               _loc3_.getChildByName(AnimeConstants.MOVIECLIP_DEFAULT_HEAD).visible = false;
               param1.name = AnimeConstants.MOVIECLIP_CUSTOM_HEAD;
               _loc3_.addChild(param1);
               param1.x = 0;
               param1.y = 0;
               param1.scaleX = Math.abs(1 / UtilPlain.getRelativeProperty(_loc3_,this.getLoader(),UtilPlain.PROPERTY_SCALEX));
               param1.scaleY = Math.abs(1 / UtilPlain.getRelativeProperty(_loc3_,this.getLoader(),UtilPlain.PROPERTY_SCALEY));
            }
         }
         _loc3_ = UtilPlain.getTail(param2);
         if(_loc3_ != null)
         {
            if(param1 != null)
            {
               _loc3_.getChildByName(AnimeConstants.MOVIECLIP_DEFAULT_TAIL).alpha = 0;
               _loc3_.getChildByName(AnimeConstants.MOVIECLIP_DEFAULT_TAIL).visible = false;
            }
         }
         else
         {
      ...
      public function set nextBehavior(param1:anifire.playback.Behaviour) : void
      {
