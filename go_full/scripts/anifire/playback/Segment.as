package anifire.playback
{
   ...
   public class Segment extends Asset
   {
      ...
      private var _tempDataStock:anifire.playback.PlayerDataStock;
      ...
      private var _prevSegment:anifire.playback.Segment = null;
      
      private var _firstSegment:anifire.playback.Segment;
      ...
      public static function connectSegment(param1:UtilHashArray, param2:UtilHashArray) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:anifire.playback.Segment = null;
         var _loc7_:anifire.playback.Segment = null;
         ...
         if(param1 != null && param2 != null && param1.length > 0 && param2.length > 0)
         {
            ...
            {
               _loc6_ = param1.getValueByIndex(_loc4_) as anifire.playback.Segment;
               _loc5_ = 0;
               while(_loc5_ < _loc8_.length)
               {
                  _loc7_ = _loc8_.getValueByIndex(_loc5_) as anifire.playback.Segment;
                  _loc9_ = false;
      ...
      public function init(param1:XML, param2:AnimeScene, param3:anifire.playback.PlayerDataStock) : Boolean
      {
         var _loc7_:XML = null;
         ...
         while(_loc11_ < _loc6_.length)
         {
            ...
            {
               _loc10_ = Number(_loc7_.child("rotation")[0].toString());
            }
            else
            {
               _loc10_ = 0;
      ...
      private function set firstSegment(param1:anifire.playback.Segment) : void
      {
         this._firstSegment = param1;
      }
      
      public function initRemoteData(param1:anifire.playback.PlayerDataStock) : void
      {
         var iDataStock:anifire.playback.PlayerDataStock = param1;
         try
         {
      ...
      private function get firstSegment() : anifire.playback.Segment
      {
      ...
      {
         var compareIndexFunction:Function;
         ...
         compareIndexFunction = function(param1:XML, param2:XML):int
         {
