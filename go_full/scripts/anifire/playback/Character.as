package anifire.playback
{
   ...
   public class Character extends Asset
   {
      ...
      private var _head:anifire.playback.Prop;
      
      private var _prop:anifire.playback.Prop;
      
      private var _face:String = null;
      
      private var _charInNextScene:anifire.playback.Character;
      
      private var _motion:anifire.playback.Motion = null;
      
      private var _lookAtCamera:Boolean = false;
      
      private var _action:anifire.playback.Action = null;
      
      private var _rotation:Number = 0;
      
      private var _wear:anifire.playback.Prop;
      ...
      private var _charInPrevScene:anifire.playback.Character;
      ...
      public static function isChanged(param1:anifire.playback.Character, param2:anifire.playback.Character) : Boolean
      {
      ...
      public static function connectCharacters(param1:UtilHashArray, param2:UtilHashArray) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:anifire.playback.Character = null;
         var _loc6_:anifire.playback.Character = null;
         ...
         if(param1 != null && param2 != null && param1.length > 0 && param2.length > 0)
         {
            ...
            {
               _loc5_ = param1.getValueByIndex(_loc3_) as anifire.playback.Character;
               _loc7_.x = _loc5_._xs[_loc5_._xs.length - 1];
               _loc7_.y = _loc5_._ys[_loc5_._ys.length - 1];
               _loc4_ = 0;
               while(_loc4_ < _loc9_.length)
               {
                  _loc6_ = _loc9_.getValueByIndex(_loc4_) as anifire.playback.Character;
      ...
      public function initDependency(param1:Number, param2:Number, param3:Number, param4:Number, param5:UtilHashArray) : void
      {
         ...
         var _loc6_:anifire.playback.Action = this._charInPrevScene != null ? this._charInPrevScene.action : null;
         var _loc7_:anifire.playback.Motion = this._charInPrevScene != null ? this._charInPrevScene.motion : null;
         ...
         if(this.prop != null)
         {
            anifire.playback.Prop.connectPropsIfNecessary(this.prop,this._charInNextScene != null ? this._charInNextScene.prop : null);
            this.prop.initDependency(null,param5);
         }
         if(this.head != null)
         {
            anifire.playback.Prop.connectPropsIfNecessary(this.head,this._charInNextScene != null ? this._charInNextScene.head : null);
            this.head.initDependency(null,param5);
         }
         if(this.wear != null)
         {
            anifire.playback.Prop.connectPropsIfNecessary(this.wear,this._charInNextScene != null ? this._charInNextScene.wear : null);
            this.wear.initDependency(null,param5);
         }
      }
      
      public function get wear() : anifire.playback.Prop
      {
         return this._wear;
      }
      ...
      override public function goToAndPause(param1:Number, param2:Number, param3:int, param4:Number) : void
      {
         ...
         if(this._state == anifire.playback.Character.STATE_MOTION)
         {
            this.motion.goToAndPause(param1 - param4 + 1);
         }
         else if(this._state == anifire.playback.Character.STATE_FADE)
         {
            this.action.goToAndPause(param1);
         }
         else if(this._state == anifire.playback.Character.STATE_ACTION)
         {
            this.action.goToAndPause(param1);
         }
      }
      ...
      public function set wear(param1:anifire.playback.Prop) : void
      {
         this._wear = param1;
      }
      ...
      public function init(param1:XML, param2:AnimeScene, param3:UtilHashArray, param4:PlayerDataStock) : Boolean
      {
         ...
         var _loc7_:XML;
         if((_loc7_ = param1.child(anifire.playback.Prop.XML_TAG)[0]) != null)
         {
            this.prop = new anifire.playback.Prop();
         ...
         var _loc8_:XML;
         if((_loc8_ = param1.child(anifire.playback.Prop.XML_TAG_HEAD)[0]) != null)
         {
            this.head = new anifire.playback.Prop();
         ...
         var _loc9_:XML;
         if((_loc9_ = param1.child(anifire.playback.Prop.XML_TAG_WEAR)[0]) != null)
         {
            this.wear = new anifire.playback.Prop();
         ...
         this.action = new anifire.playback.Action();
         if(!(_loc5_ = this.action.init(param1.child(anifire.playback.Action.XML_TAG)[0],param3,param4)))
         {
         ...
         while(_loc6_ < param1.child("color").length())
         {
            ...
            _loc11_ = new SelectedColor(_loc10_.@r,_loc10_.attribute("oc").length() == 0 ? uint.MAX_VALUE : uint(_loc10_.@oc),uint(_loc10_));
      ...
      private function updateActionStaticProperty() : void
      {
         ...
         if(this.prop != null)
         {
            this.prop.propagateCharState(anifire.playback.Character.STATE_ACTION);
         }
         if(this.head != null)
         {
            this.head.propagateCharState(anifire.playback.Character.STATE_ACTION);
         }
         if(this.wear != null)
         {
            this.wear.propagateCharState(anifire.playback.Character.STATE_ACTION);
         }
      }
      ...
      public function get action() : anifire.playback.Action
      {
         return this._action;
      }
      ...
      private function attachAllProps(param1:Behaviour) : void
      {
         ...
         if(this.head != null)
         {
            param1.setHead(this.head.getBundle());
         }
         else
         {
            param1.removeHead();
      ...
      public function set head(param1:anifire.playback.Prop) : void
      {
         this._head = param1;
      }
      
      public function get motion() : anifire.playback.Motion
      {
         return this._motion;
      }
      ...
      public function initRemoteData(param1:PlayerDataStock) : void
      {
         ...
         _loc2_.addEventListener(LoadMgrEvent.ALL_COMPLETE,this.onInitRemoteDataCompleted);
         if(this.motion != null)
         {
            _loc2_.addEventDispatcher(this.motion.getEventDispatcher(),PlayerEvent.INIT_REMOTE_DATA_COMPLETE);
            this.motion.addEventListener("MotionSoundRdy",this.initSound);
            this.motion.initRemoteData(param1,this.isCC);
         }
         if(this.action != null)
         {
            _loc2_.addEventDispatcher(this.action.getEventDispatcher(),PlayerEvent.INIT_REMOTE_DATA_COMPLETE);
            this.action.addEventListener("SoundRdy",this.initSound);
            this.action.initRemoteData(param1,this.isCC);
         }
         if(this.prop != null)
         {
            _loc2_.addEventDispatcher(this.prop.getEventDispatcher(),PlayerEvent.INIT_REMOTE_DATA_COMPLETE);
            this.prop.initRemoteData(param1,this.prop.isCC);
         }
         if(this.head != null)
         {
            _loc2_.addEventDispatcher(this.head.getEventDispatcher(),PlayerEvent.INIT_REMOTE_DATA_COMPLETE);
            this.head.initRemoteData(param1,this.head.isCC);
         }
         if(this.wear != null)
         {
            _loc2_.addEventDispatcher(this.wear.getEventDispatcher(),PlayerEvent.INIT_REMOTE_DATA_COMPLETE);
            this.wear.initRemoteData(param1,this.wear.isCC);
         }
         _loc2_.commit();
         this.setState(anifire.playback.Character.STATE_NULL);
      }
      ...
      public function set prop(param1:anifire.playback.Prop) : void
      {
         this._prop = param1;
      }
      ...
      override protected function setState(param1:int) : void
      {
         ...
         trace("**************Current state************ " + this.state);
         trace("**************Changing state************ " + param1);
         if(param1 == anifire.playback.Character.STATE_MOTION)
         {
         ...
         else if(param1 == anifire.playback.Character.STATE_FADE)
         {
            if(this._state != anifire.playback.Character.STATE_ACTION)
            {
               UtilPlain.removeAllSon(this._bundle);
         ...
         else if(param1 == anifire.playback.Character.STATE_ACTION)
         {
            if(this._state != anifire.playback.Character.STATE_ACTION)
            {
               UtilPlain.removeAllSon(this._bundle);
      ...
      public function get prop() : anifire.playback.Prop
      {
         return this._prop;
      }
      
      public function get head() : anifire.playback.Prop
      {
         return this._head;
      }
      ...
      private function updateMotionStaticProperty() : void
      {
         if(this.motion != null)
         {
            if(this.prop != null)
            {
               this.prop.propagateCharState(anifire.playback.Character.STATE_MOTION);
            }
            if(this.head != null)
            {
               this.head.propagateCharState(anifire.playback.Character.STATE_MOTION);
            }
            if(this.wear != null)
            {
      ...
      public function updateProperties(param1:Number = 0, param2:Number = 0) : void
      {
         ...
         if(!(this._state == anifire.playback.Character.STATE_MOTION && !this.motion.getIsBlink()))
         {
            if(this._state == anifire.playback.Character.STATE_FADE)
            {
      ...
      public function set action(param1:anifire.playback.Action) : void
      {
         this._action = param1;
      ...
      override public function propagateSceneState(param1:int) : void
      {
         ...
         {
            this.setState(anifire.playback.Character.STATE_ACTION);
         }
         else if(param1 == AnimeScene.STATE_MOTION)
         {
            if(this._charInNextScene == null)
            {
               this.setState(anifire.playback.Character.STATE_FADE);
            }
            else if(this.motion == null)
            {
               this.setState(anifire.playback.Character.STATE_ACTION);
            }
            else if(anifire.playback.Character.isChanged(this,this._charInNextScene))
            {
               this.setState(anifire.playback.Character.STATE_MOTION);
            }
            else
            {
               this.setState(anifire.playback.Character.STATE_ACTION);
      ...
      public function set motion(param1:anifire.playback.Motion) : void
      {
         this._motion = param1;
