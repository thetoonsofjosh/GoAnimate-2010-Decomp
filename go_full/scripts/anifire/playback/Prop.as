package anifire.playback
{
   ...
   public class Prop extends Asset
   {
      ...
      private var _propInNextScene:anifire.playback.Prop;
      ...
      private var _firstProp:anifire.playback.Prop = null;
      
      private var _ccMakerInitHandlers:Boolean = false;
      
      private var _propInPrevScene:anifire.playback.Prop;
      ...
      public static function connectPropsIfNecessary(param1:anifire.playback.Prop, param2:anifire.playback.Prop) : Boolean
      {
      ...
      public static function connectPropsBetweenScenes(param1:UtilHashArray, param2:UtilHashArray) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:anifire.playback.Prop = null;
         var _loc6_:anifire.playback.Prop = null;
         ...
         if(param1 != null && param2 != null && param1.length > 0 && param2.length > 0)
         {
            ...
            {
               _loc5_ = param1.getValueByIndex(_loc3_) as anifire.playback.Prop;
               _loc4_ = 0;
               while(_loc4_ < _loc8_.length)
               {
                  _loc6_ = _loc8_.getValueByIndex(_loc4_) as anifire.playback.Prop;
      ...
      public static function isChanged(param1:anifire.playback.Prop, param2:anifire.playback.Prop) : Boolean
      {
      ...
      public function init(param1:XML, param2:AnimeScene, param3:PlayerDataStock) : Boolean
      {
         ...
         while(j < propXML.child("color").length())
         {
            ...
            selectedColor = new SelectedColor(colorXML.@r,colorXML.attribute("oc").length() == 0 ? uint.MAX_VALUE : uint(colorXML.@oc),uint(colorXML));
      ...
      private function get firstProp() : anifire.playback.Prop
      {
      ...
      public function initRemoteData(param1:PlayerDataStock, param2:Boolean = false) : void
      {
         ...
         else
         {
            ...
            ccMaker.initBySwfs(iDataStock.getPlayerData(this.file)["xml"],iDataStock.getPlayerData(this.file)["imageData"]);
         }
      }
      ...
      {
         if(param1 == anifire.playback.Prop.STATE_ACTION)
         {
         ...
         else if(param1 == anifire.playback.Prop.STATE_MOTION)
         {
            this.getBundle().addChild(this.objInsideBundle);
            this.flip();
            if(this.isFirstProp)
      ...
      private function set firstProp(param1:anifire.playback.Prop) : void
      {
      ...
      {
         if(this.facing == anifire.playback.Prop.FACE_POSITIVE)
         {
            if(this.getIsVideo())
            {
      ...
      {
         var _loc3_:anifire.playback.Prop = null;
         ...
         else
         {
            ...
            if(this.getIsVideo())
            {
               ...
               {
                  _loc4_ += _loc3_.parentScene.getDuration();
      ...
      override public function propagateSceneState(param1:int) : void
      {
         ...
         {
            this.setState(anifire.playback.Prop.STATE_ACTION);
         }
         ...
         {
            this.setState(anifire.playback.Prop.STATE_NULL);
         }
      }
