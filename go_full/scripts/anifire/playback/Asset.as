package anifire.playback
{
   ...
   public class Asset implements IEventDispatcher
   {
      ...
      private var _parentScene:anifire.playback.AnimeScene;
      ...
      public function get parentScene() : anifire.playback.AnimeScene
      {
         return this._parentScene;
      }
      
      public function set parentScene(param1:anifire.playback.AnimeScene) : void
      {
      ...
      protected function initAsset(param1:String, param2:int, param3:anifire.playback.AnimeScene) : void
      {
         this.id = param1;
