package anifire.playback
{
   ...
   public class DownloadManager extends EventDispatcher
   {
      ...
      private var _anime:anifire.playback.Anime;
      ...
      public function initDependency(param1:int, param2:DisplayObjectContainer, param3:anifire.playback.Anime) : void
      {
      ...
      private function drawDownloadStatus() : void
      {
         ...
         while(_loc10_ < this._sounds.length)
         {
            ...
            if(_loc11_ is ProgressiveSoundItem)
            {
               ...
               _loc4_.graphics.beginFill(_loc14_ >= 1 ? 16711680 : 13421772,_loc14_ >= 1 ? 1 : 0.5);
         ...
         _loc5_.graphics.drawRect(UtilUnitConvert.frameToSec(this._anime.currentFrame) * 1000 * _loc9_,0,2,_loc8_);
...
class StreamSoundItem extends SoundItem
{
   ...
   public function StreamSoundItem()
   {
      super();
   }
...
class VideoStreamSoundItem extends SoundItem
{
   ...
   public function VideoStreamSoundItem()
   {
      super();
   }
...
class ProgressiveSoundItem extends SoundItem
{
   ...
   public function ProgressiveSoundItem()
   {
      super();
   }
...
class DownloadServiceProvider
{
   ...
   public function DownloadServiceProvider()
   {
      super();
   }
