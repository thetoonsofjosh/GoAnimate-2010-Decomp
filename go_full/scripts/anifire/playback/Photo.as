package anifire.playback
{
   ...
   public class Photo extends EventDispatcher
   {
      ...
      private function getDisplacementToCenterAlign2Rectangle(param1:Rectangle, param2:Rectangle) : Point
      {
         ...
         var _loc4_:Point;
         return (_loc4_ = new Point((param1.left + param1.right) / 2,(param1.top + param1.bottom) / 2)).subtract(_loc3_);
      }
      ...
      private function processBitmap(param1:Bitmap, param2:Rectangle, param3:Number) : void
      {
         ...
         var _loc11_:int = _loc9_ == _loc10_ ? _loc7_ : _loc8_;
         var _loc12_:int;
         var _loc13_:Number = (_loc12_ = _loc9_ == _loc10_ ? _loc8_ : _loc7_) / _loc11_;
         ...
         var _loc17_:Matrix;
         (_loc17_ = new Matrix()).translate(-_loc7_ / 2,-_loc8_ / 2);
         _loc17_.rotate(Math.PI * param3 / 180);
         _loc17_.translate(_loc15_ / 2,_loc16_ / 2);
         var _loc18_:BitmapData;
         (_loc18_ = new BitmapData(_loc15_,_loc16_)).draw(_loc4_,_loc17_);
      ...
      private function doAddPhotoFrame(param1:Event) : void
      {
         ...
         while(_loc2_ < this.photo_containers.length)
         {
            ...
            _loc6_ = (_loc5_ = _loc3_.getChildByName("PIC") as DisplayObjectContainer).getRect(_loc3_);
      ...
      private function rotateAndPositionAndResizeObj(param1:DisplayObject, param2:Rectangle) : void
      {
         ...
         var _loc4_:Sprite;
         (_loc4_ = new Sprite()).addChild(param1);
