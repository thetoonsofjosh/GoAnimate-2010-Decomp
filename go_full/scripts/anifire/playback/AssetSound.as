package anifire.playback
{
   ...
   public class AssetSound extends EventDispatcher
   {
      ...
      private var _anime:anifire.playback.Anime = null;
      
      private var _numOfPendingJobs:int = 0;
      
      public function AssetSound(param1:anifire.playback.Anime)
      {
         super();
         if(this._anime == null)
         {
      ...
      private function BufferCompleteHandler(param1:Event) : void
      {
         ...
         var _loc5_:Boolean = Boolean(_loc3_.setVolumeOnly);
         var _loc6_:Number = Number(_loc3_.curFrame);
         var _loc7_:String;
         if((_loc7_ = String(_loc3_.startFlag)) == null || _loc7_ == "")
         {
            _loc7_ = "";
         }
