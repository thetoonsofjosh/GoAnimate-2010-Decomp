package anifire.playback
{
   ...
   public class Background extends Asset
   {
      ...
      private var _firstBg:anifire.playback.Background;
      
      private var _file:String;
      
      private var _bgInPrevScene:anifire.playback.Background;
      
      private var _bgInNextScene:anifire.playback.Background;
      ...
      public function init(param1:XML, param2:AnimeScene, param3:PlayerDataStock) : Boolean
      {
         ...
         this.setState(anifire.playback.Background.STATE_NULL);
         this._xs = new Array();
         ...
         while(_loc6_ < param1.child("color").length())
         {
            ...
            _loc7_ = new SelectedColor(_loc5_.@r,_loc5_.attribute("oc").length() == 0 ? uint.MAX_VALUE : uint(_loc5_.@oc),uint(_loc5_));
      ...
      private function get firstBg() : anifire.playback.Background
      {
      ...
      private function set firstBg(param1:anifire.playback.Background) : void
      {
      ...
      override public function propagateSceneState(param1:int) : void
      {
         if(param1 == AnimeScene.STATE_ACTION)
         {
            ...
            this.setState(anifire.playback.Background.STATE_ACTION);
         }
      ...
      public function initDependency(param1:anifire.playback.Background, param2:Number) : void
      {
