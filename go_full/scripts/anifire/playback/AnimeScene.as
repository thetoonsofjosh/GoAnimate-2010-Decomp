package anifire.playback
{
   ...
   public class AnimeScene extends EventDispatcher implements IPlayable
   {
      ...
      private var _parentAnime:anifire.playback.Anime;
      ...
      private var _prevScene:anifire.playback.AnimeScene;
      ...
      private var _nextScene:anifire.playback.AnimeScene;
      ...
      public function goToAndPause(param1:Number) : void
      {
         ...
         this.play(param1);
         if(this.getState() == anifire.playback.AnimeScene.STATE_ACTION)
         {
            _loc4_ = 1;
         }
         if(this.getState() == anifire.playback.AnimeScene.STATE_MOTION)
         {
      ...
      private function onInitRemoteDataCompleted(param1:Event) : void
      {
         ...
         this.setState(anifire.playback.AnimeScene.STATE_NULL);
      ...
      public function init(param1:XML, param2:anifire.playback.Anime, param3:UtilHashArray, param4:PlayerDataStock, param5:Number, param6:String, param7:Boolean) : void
      {
         var _loc8_:int = 0;
         ...
         for each(_loc19_ in param1.child(EffectAsset.XML_TAG))
         {
            ...
            {
               _loc23_ = Boolean((_loc22_ = new AnimeEffectAsset()).init(_loc19_,this,param4,_loc20_));
            }
            if(_loc23_)
            {
      ...
      public function get prevScene() : anifire.playback.AnimeScene
      {
      ...
      public function initRemoteData(param1:PlayerDataStock) : void
      {
         ...
         if(this.getState() != anifire.playback.AnimeScene.STATE_BUFFER_INITIALIZING)
         {
            ...
            this.setState(anifire.playback.AnimeScene.STATE_BUFFER_INITIALIZING);
            _loc2_.commit();
         }
      }
      ...
      public function play(param1:Number) : void
      {
         ...
         var _loc6_:Array = this._characters.getArray();
         var _loc7_:Array = this._bubbles.getArray();
         var _loc8_:Array = this._bgs.getArray();
         var _loc9_:Array = this._props.getArray();
         var _loc10_:Array = this._effects.getArray();
         if(param1 < this.getLastActionFrame() || this._nextScene == null)
         {
            if(this.getState() != anifire.playback.AnimeScene.STATE_ACTION)
            {
               this.setState(anifire.playback.AnimeScene.STATE_ACTION);
            }
            _loc4_ = param1 - this._startFrame;
            _loc3_ = this.getNumBub();
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
               _loc7_[_loc2_].updateProperties(_loc4_);
               _loc2_++;
            }
            _loc4_ = (param1 - this._startFrame) / (this._actionDuration - 1);
            _loc5_ = 1 / (this._actionDuration - 1);
            _loc3_ = this.getNumChar();
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
               _loc6_[_loc2_].updateProperties(_loc4_,_loc5_);
               _loc2_++;
            }
            _loc3_ = this.getNumProp();
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
               _loc9_[_loc2_].updateProperties(_loc4_);
               _loc2_++;
            }
         }
         else
         {
            _loc4_ = (param1 - this._startFrame - this._actionDuration + 1) / (this._endFrame - this._startFrame - this._actionDuration + 1);
            if(this.getState() != anifire.playback.AnimeScene.STATE_MOTION)
            {
               this.setState(anifire.playback.AnimeScene.STATE_MOTION);
            }
            _loc3_ = this.getNumChar();
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
               _loc6_[_loc2_].updateProperties(_loc4_);
               _loc2_++;
            }
            _loc3_ = this.getNumBub();
            _loc2_ = 0;
            ...
            _loc3_ = this.getNumBg();
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
               _loc8_[_loc2_].updateProperties(_loc4_);
               _loc2_++;
            }
            _loc3_ = this.getNumProp();
            _loc2_ = 0;
         ...
         _loc3_ = this.getNumEffect();
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
            _loc10_[_loc2_].play(param1);
            _loc2_++;
         }
      }
      ...
      public function get nextScene() : anifire.playback.AnimeScene
      {
      ...
      public function initDependency(param1:anifire.playback.AnimeScene, param2:anifire.playback.AnimeScene, param3:Number, param4:DownloadManager, param5:UtilHashArray) : void
      {
         var _loc6_:int = 0;
         ...
         while(_loc6_ < this.getNumChar())
         {
            ...
            _loc15_ = param2 != null ? param2.getActionDuration() : 0;
            _loc16_ = param2 != null ? param2.getMotionDuration() : 0;
      ...
      private function set parentAnime(param1:anifire.playback.Anime) : void
      {
      ...
      private function get parentAnime() : anifire.playback.Anime
      {
