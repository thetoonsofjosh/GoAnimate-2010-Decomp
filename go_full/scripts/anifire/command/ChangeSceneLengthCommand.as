package anifire.command
{
   ...
   public class ChangeSceneLengthCommand extends SuperCommand
   {
      ...
      override public function undo() : void
      {
         ...
         Console.getConsole().timeline.updateSceneLength(this._undoLength,this._sceneIndex);
      ...
      {
         Console.getConsole().timeline.updateSceneLength(this._redoLength,this._sceneIndex);
