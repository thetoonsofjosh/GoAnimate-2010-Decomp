package anifire.command
{
   ...
   public class ResizePropCommand extends SuperCommand
   {
      ...
      public function ResizePropCommand(param1:String, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         super();
         this._id = param1;
