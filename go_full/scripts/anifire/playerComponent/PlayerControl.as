package anifire.playerComponent
{
   ...
   public class PlayerControl extends HBox
   {
      ...
      private var _673913090fullScreenControl:anifire.playerComponent.FullScreenControl;
      ...
      private var _1969341667volumeControl:anifire.playerComponent.VolumeControl;
      
      private var _isTimeLineDragging:Boolean = false;
      
      private var _2077603743timeLine:HSlider;
      
      private var _431284669timerDisplay:anifire.playerComponent.TimerDisplay;
            ...
            "propertiesFactory":function():Object
            {
               return {
                  ...
                  "childDescriptors":[new UIComponentDescriptor({
                     ...
                     "type":anifire.playerComponent.TimerDisplay,
                     "id":"timerDisplay",
                     "propertiesFactory":function():Object
                     {
                     ...
                     "type":anifire.playerComponent.VolumeControl,
                     "id":"volumeControl",
                     ...
                     "type":anifire.playerComponent.FullScreenControl,
      ...
      public function set fullScreenControl(param1:anifire.playerComponent.FullScreenControl) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get fullScreenControl() : anifire.playerComponent.FullScreenControl
      {
      ...
      [Bindable(event="propertyChange")]
      public function get timerDisplay() : anifire.playerComponent.TimerDisplay
      {
      ...
      public function set volumeControl(param1:anifire.playerComponent.VolumeControl) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get volumeControl() : anifire.playerComponent.VolumeControl
      {
      ...
      public function set timerDisplay(param1:anifire.playerComponent.TimerDisplay) : void
      {
