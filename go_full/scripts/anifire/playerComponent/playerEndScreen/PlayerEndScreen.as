   ...
   public class PlayerEndScreen extends Canvas implements IBindingClient
   {
      ...
      public function get gigyaConfig() : Object
      {
         ...
         if(this._gigyaConfig == null)
         {
            ...
            movieOwnerName = String(urlVar["movieOwner"]);
            movieOwnerId = !!urlVar["movieOwnerId"] ? String(urlVar["movieOwnerId"]) : null;
            movieId = !!urlVar["movieId"] ? String(urlVar["movieId"]) : "";
            movieLicenseId = !!urlVar[ServerConstants.FLASHVAR_MOVIE_LICENSE_ID] ? String(urlVar[ServerConstants.FLASHVAR_MOVIE_LICENSE_ID]) : "";
            if(movieId == "")
            {
               movieId = String(Application.application.parameters["movieId"]);
            }
            movieTitle = !!urlVar["movieTitle"] ? String(urlVar["movieTitle"]) : "";
            movieDesc = !!urlVar["movieDesc"] ? String(urlVar["movieDesc"]) : "";
            userId = !!urlVar["userId"] ? String(urlVar["userId"]) : "";
            chainMovieIds = !!urlVar[ServerConstants.FLASHVAR_CHAIN_MOVIE_ID] ? String(urlVar[ServerConstants.FLASHVAR_CHAIN_MOVIE_ID]) : "";
            apiServer = String(urlVar["apiserver"]);
            appCode = String(urlVar["appCode"]);
            ...
            fbAppUrl = String(urlVar["fb_app_url"]);
            client_theme_code = String(urlVar[ServerConstants.FLASHVAR_CLIENT_THEME_CODE]);
            client_language_code = String(urlVar[ServerConstants.FLASHVAR_CLIENT_THEME_LANG_CODE]);
      ...
      override public function initialize() : void
      {
         ...
         bindings = this._PlayerEndScreen_bindingsSetup();
         watchers = [];
         target = this;
