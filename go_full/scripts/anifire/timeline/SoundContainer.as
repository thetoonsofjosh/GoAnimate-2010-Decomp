package anifire.timeline
{
   ...
   public class SoundContainer extends Canvas implements ITimelineContainer, IBindingClient
   {
      ...
      private var _tempSoundInfo2:anifire.timeline.ElementInfo;
      ...
      private var _tempSoundInfo:anifire.timeline.ElementInfo;
      ...
      private var _1812817726soundItem:anifire.timeline.SoundElement;
      ...
      public function SoundContainer()
      {
                  ...
                  "childDescriptors":[new UIComponentDescriptor({
                     ...
                     "propertiesFactory":function():Object
                     {
                        return {
                           ...
                           "clipContent":false,
                           "childDescriptors":[new UIComponentDescriptor({
                              "type":anifire.timeline.SoundElement,
                              "id":"soundItem",
                              "propertiesFactory":function():Object
                              {
                                 return {
         ...
         this._tempSoundInfo = new anifire.timeline.ElementInfo(anifire.timeline.ElementInfo.SCENE,"");
         this._tempSoundInfo2 = new anifire.timeline.ElementInfo(anifire.timeline.ElementInfo.SCENE,"");
      ...
      private function onMouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         {
            _loc2_ = this._currDraggedControl.x - this.right_arrow_orig_x;
            this.slength += _loc2_;
         ...
         {
            _loc4_ = Number(this.arrow_right.x);
      ...
      public function get tempSoundInfo2() : anifire.timeline.ElementInfo
      {
      ...
      [Bindable(event="propertyChange")]
      public function get soundItem() : anifire.timeline.SoundElement
      {
         return this._1812817726soundItem;
      }
      
      public function set tempSoundInfo2(param1:anifire.timeline.ElementInfo) : void
      {
      ...
      public function get tempSoundInfo() : anifire.timeline.ElementInfo
      {
      ...
      private function fixedChannelY(param1:Number) : Number
      {
         ...
         var _loc6_:int = 0;
         var _loc2_:Number = 4;
         var _loc3_:Number = param1 - (this._timelineControl.y + this._timelineControl.scene_vb.height);
         if(_loc3_ > 0)
         {
            _loc5_ = this._timelineControl.sound_cs.height - this.SOUNDCONTAINER_HEIGHT;
            _loc6_ = (_loc6_ = UtilUnitConvert.getTargetPoint(0,_loc5_,_loc3_,_loc2_)) == 0 ? int(_loc2_ - 1) : _loc6_ - 1;
      ...
      public function set soundItem(param1:anifire.timeline.SoundElement) : void
      {
      ...
      override public function initialize() : void
      {
         ...
         bindings = this._SoundContainer_bindingsSetup();
         watchers = [];
         target = this;
      ...
      public function set tempSoundInfo(param1:anifire.timeline.ElementInfo) : void
      {
