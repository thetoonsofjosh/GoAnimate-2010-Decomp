package anifire.timeline
{
   ...
   public class TimelineEvent extends Event
   {
      ...
      private var _soundContainer:anifire.timeline.SoundContainer;
      
      private var _index:int;
      
      private var _id:String;
      
      public function TimelineEvent(param1:String, param2:Number = -1, param3:String = null, param4:anifire.timeline.SoundContainer = null, param5:Boolean = false, param6:Boolean = false)
      {
      ...
      public function set soundContainer(param1:anifire.timeline.SoundContainer) : void
      {
      ...
      public function get soundContainer() : anifire.timeline.SoundContainer
      {
