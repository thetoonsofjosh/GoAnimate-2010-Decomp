package anifire.timeline
{
   ...
   public class SoundElement extends Canvas implements ITimelineElement
   {
      ...
      private var _soundContainer:anifire.timeline.SoundContainer = null;
      ...
      public function SoundElement()
      {
         ...
         this._fillColors = [13421772,13421772];
      ...
      public function redraw() : void
      {
         ...
         this.soundLabel.width = this._length > 1000 ? 1000 : (this._length < 0 ? 0 : this._length - 10);
         this.soundLabel.x = 5;
      ...
      public function setSoundContainerReferer(param1:anifire.timeline.SoundContainer) : void
      {
