package anifire.playerEffect
{
   ...
   public class AnimeEffectAsset extends EffectAsset
   {
      ...
      private var _prevEffect:anifire.playerEffect.AnimeEffectAsset;
      
      private var _effectXML:XML;
      
      private var _nextEffect:anifire.playerEffect.AnimeEffectAsset;
      ...
      private var _firstEffect:anifire.playerEffect.AnimeEffectAsset;
      ...
      public static function connectEffectsBetweenScenes(param1:UtilHashArray, param2:UtilHashArray) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:anifire.playerEffect.AnimeEffectAsset = null;
         var _loc6_:anifire.playerEffect.AnimeEffectAsset = null;
         ...
         if(param1 != null && param2 != null && param1.length > 0 && param2.length > 0)
         {
            ...
            {
               _loc5_ = param1.getValueByIndex(_loc3_) as anifire.playerEffect.AnimeEffectAsset;
               _loc4_ = 0;
               while(_loc4_ < _loc9_.length)
               {
                  _loc6_ = _loc9_.getValueByIndex(_loc4_) as anifire.playerEffect.AnimeEffectAsset;
