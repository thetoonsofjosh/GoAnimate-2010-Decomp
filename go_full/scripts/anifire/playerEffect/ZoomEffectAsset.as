package anifire.playerEffect
{
   ...
   public class ZoomEffectAsset extends ProgramEffectAsset
   {
      ...
      private var _prevZoom:anifire.playerEffect.ZoomEffectAsset;
      ...
      private var _refZoom:anifire.playerEffect.ZoomEffectAsset;
      ...
      public static function isDummyZoomNeededForCurrentZoom(param1:anifire.playerEffect.ZoomEffectAsset) : Boolean
      {
         if(param1 != null)
         {
      ...
      public static function isDummyZoomNeededForPreviousZoom(param1:anifire.playerEffect.ZoomEffectAsset, param2:anifire.playerEffect.ZoomEffectAsset) : Boolean
      {
         if(param1 != null)
         {
      ...
      public function set refZoom(param1:anifire.playerEffect.ZoomEffectAsset) : void
      {
         this._refZoom = param1;
      }
      
      public function get refZoom() : anifire.playerEffect.ZoomEffectAsset
      {
      ...
      public function init(param1:XML, param2:AnimeScene, param3:DisplayObjectContainer) : void
      {
         ...
         this._effectX = _loc6_ = Number(param1.x);
         this._effectY = _loc7_ = Number(param1.y);
      ...
      public function get prevZoom() : anifire.playerEffect.ZoomEffectAsset
      {
      ...
      public function initDependency(param1:Number, param2:Number, param3:anifire.playerEffect.ZoomEffectAsset) : void
      {
      ...
      public function set prevZoom(param1:anifire.playerEffect.ZoomEffectAsset) : void
      {
      ...
      public function initDummyZoom(param1:AnimeScene, param2:DisplayObjectContainer, param3:anifire.playerEffect.ZoomEffectAsset, param4:anifire.playerEffect.ZoomEffectAsset, param5:String = "mode_normal") : void
      {
         trace("initDummyZoom");
