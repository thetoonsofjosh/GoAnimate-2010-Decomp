package anifire.core
{
   ...
   public class Thumb implements IEventDispatcher
   {
      ...
      private var _theme:anifire.core.Theme;
      ...
      public function set theme(param1:anifire.core.Theme) : void
      {
         this._theme = param1;
      }
      ...
      public function get theme() : anifire.core.Theme
      {
         return this._theme;
      }
      ...
      public function deSerialize(param1:XML, param2:anifire.core.Theme, param3:Boolean = false) : void
      {
      ...
      internal function loadProxyImageComplete(param1:Event) : void
      {
      }
      ...
      public function getColorSetById(param1:String) : UtilHashArray
      {
         ...
         while(_loc4_ < _loc2_.color.length())
         {
            ...
            _loc6_ = new SelectedColor(_loc5_.@r,_loc5_.attribute("oc").length() == 0 ? uint.MAX_VALUE : uint(_loc5_.@oc),uint(_loc5_));
