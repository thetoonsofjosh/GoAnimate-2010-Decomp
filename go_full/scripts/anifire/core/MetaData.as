package anifire.core
{
   ...
   public class MetaData
   {
      ...
      {
         return "<" + XML_NODE_NAME + ">" + "<title>" + UtilXmlInfo.xmlEscape(this.title) + "</title>" + "<tag>" + UtilXmlInfo.xmlEscape(this.getUgcTagString()) + "</tag>" + "<hiddenTag>" + UtilXmlInfo.xmlEscape(this.getHiddenTagString()) + "</hiddenTag>" + "<desc>" + UtilXmlInfo.xmlEscape(this.description) + "</desc>" + "<mver>" + UtilXmlInfo.xmlEscape(this.mver.toString()) + "</mver>" + "</" + XML_NODE_NAME + ">";
      }
      ...
      public function deSerialize(param1:XML, param2:String, param3:String) : void
      {
         ...
         this.movieId = param2;
         this.mver = Number(param1.child("mver")[0]) >= 0 ? Number(param1.child("mver")[0]) : 0;
      }
