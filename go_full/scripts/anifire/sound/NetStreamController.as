package anifire.sound
{
   ...
   public class NetStreamController extends EventDispatcher
   {
      ...
      private var _netClient:anifire.sound.NetStreamClient;
      ...
      private function set netClient(param1:anifire.sound.NetStreamClient) : void
      {
      ...
      private function doStartLoadNetstream(param1:NetStatusEvent) : void
      {
         ...
         if(param1.info.code == "NetConnection.Connect.Success")
         {
            ...
            _loc2_ = String(param1.info.secureToken);
            if(_loc2_ != null)
            {
            ...
            this.netClient = new anifire.sound.NetStreamClient();
      ...
      private function get netClient() : anifire.sound.NetStreamClient
      {
...
class PlayHeadCommand
{
   ...
   public function PlayHeadCommand(param1:int, param2:Number = 0)
   {
      super();
