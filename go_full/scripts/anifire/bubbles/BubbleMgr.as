package anifire.bubble
{
   public class BubbleMgr
   {
      ...
      private static var _bubble:anifire.bubble.Bubble = new anifire.bubble.Bubble();
      ...
      public static function getBubble(param1:String = "RECTANGULAR") : anifire.bubble.Bubble
      {
      ...
      public static function isSameBubble(param1:anifire.bubble.Bubble, param2:anifire.bubble.Bubble) : Boolean
      {
      ...
      public static function getBubbleByXML(param1:XML, param2:Number = -1) : anifire.bubble.Bubble
      {
         var _loc3_:String = param1.@type;
         var _loc4_:anifire.bubble.Bubble;
      ...
      private static function createBubble(param1:String = "RECTANGULAR") : anifire.bubble.Bubble
      {
         switch(param1)
         {
            case RECTANGULAR:
               _bubble = new PlainRectangularBubble() as anifire.bubble.Bubble;
               _name += "_" + RECTANGULAR;
               return _bubble;
            case ROUNDRECTANGULAR:
               _bubble = new RoundedRectangularBubble() as anifire.bubble.Bubble;
               _name += "_" + ROUNDRECTANGULAR;
               return _bubble;
            case ELLIPSE:
               _bubble = new EllipseBubble() as anifire.bubble.Bubble;
               _name += "_" + ELLIPSE;
               return _bubble;
            case CLOUD:
               _bubble = new CloudBubble() as anifire.bubble.Bubble;
               _name += "_" + CLOUD;
               return _bubble;
            case HEART:
               _bubble = new HeartBubble() as anifire.bubble.Bubble;
               _name += "_" + HEART;
               return _bubble;
            case BOOM:
               _bubble = new BoomBubble() as anifire.bubble.Bubble;
               _name += "_" + BOOM;
               return _bubble;
            case BLANK:
               _bubble = new BlankBubble() as anifire.bubble.Bubble;
               _name += "_" + BLANK;
               return _bubble;
            case BLANKTAIL:
               _bubble = new BlankTailBubble() as anifire.bubble.Bubble;
               _name += "_" + BLANK;
               return _bubble;
            default:
               _bubble = new PlainRectangularBubble() as anifire.bubble.Bubble;
