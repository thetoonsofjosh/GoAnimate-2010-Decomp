package
{
   ...
   public class _anifire_component_DoubleStateButtonWatcherSetupUtil extends Sprite implements IWatcherSetupUtil
   {
      ...
      {
         param4[0] = new PropertyWatcher("but1StyleName",{"propertyChange":true},[param3[0]],param2);
         param4[1] = new PropertyWatcher("but2StyleName",{"propertyChange":true},[param3[1]],param2);
