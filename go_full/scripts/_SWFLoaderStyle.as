package
{
   ...
   public class _SWFLoaderStyle
   {
      ...
      private static var _embed_css_Assets_swf___brokenImage_259424322:Class = _SWFLoaderStyle__embed_css_Assets_swf___brokenImage_259424322;
      ...
      public static function init(param1:IFlexModuleFactory) : void
      {
         ...
         if(style.defaultFactory == null)
         {
            style.defaultFactory = function():void
            {
               ...
               this.brokenImageSkin = _embed_css_Assets_swf___brokenImage_259424322;
